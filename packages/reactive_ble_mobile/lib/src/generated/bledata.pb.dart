...
class ScanForDevicesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanForDevicesRequest', createEmptyInstance: create)
    ...
    ..p<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'companyIds', $pb.PbFieldType.K3, protoName: 'companyIds')
  ...
  factory ScanForDevicesRequest({
    ...
    $core.Iterable<$core.int>? companyIds,
  }) {
    ...
    if (companyIds != null) {
      _result.companyIds.addAll(companyIds);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(4)
  $core.List<$core.int> get companyIds => $_getList(3);
}
...
class DeviceScanInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceScanInfo', createEmptyInstance: create)
    ...
    ..p<$core.int>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'companyIds', $pb.PbFieldType.K3, protoName: 'companyIds')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $core.List<$core.int> get companyIds => $_getList(7);
}
