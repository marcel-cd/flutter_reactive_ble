...
interface BleClient {
    ...
    fun scanForDevices(services: List<ParcelUuid>, companies: List<Int>, scanMode: ScanMode, requireLocationServicesEnabled: Boolean): Observable<com.signify.hue.flutterreactiveble.ble.ScanInfo>
